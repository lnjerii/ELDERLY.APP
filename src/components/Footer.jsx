        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 leading-relaxed">
              ...
              Our platform connects caregivers, families, and healthcare professionals to ensure 
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-700 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110">
                <svg className="w-5 h-5" fill="currntColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tasks" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Tasks
                </Link>
              </li>
              <li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">support@elderlycare.com</p>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Elderly Care System. All rights reserved.
            </p>
            <p className="text-gray-400 text-sm">
              Developed by <span className="text-blue-400 font-semibold">Wanjiru Lucy Njeri</span>
            </p>
          </div>
        </div>
      </div>
